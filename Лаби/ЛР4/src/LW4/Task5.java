...
public class Task1 {
    ...
    public void print() {
        LW4.Task1.StaticClass staticClass = new LW4.Task1.StaticClass();
        staticClass.print();
        LW4.Task1.NotStaticClass notStaticClass = new LW4.Task1.NotStaticClass();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new LW4.Task1());
        System.out.println("Task 2");
        LW4.Task1 app = new LW4.Task1();
